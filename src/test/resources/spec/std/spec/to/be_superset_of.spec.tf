...
library spec {
  ...
  spec:
   ...
   describe("to.be_superset_of", [

     subject(to.be_superset_of({})),
     ...
     describe("of {:a 1, :b NaN}", [
       ...
       subject(to.be_superset_of({:a 1, :b NaN})),
     ...
     describe("of {:a 1, :b core.id}", [
       ...
       subject(to.be_superset_of({:a 1, :b core.id})),
     ...
     describe("of {:a 1, :b 2, :c 3}", [
       ...
       subject(to.be_superset_of({:a 1, :b 2, :c 3})),
       ...
       it ("matches {:a 1, :b 2, :c 3, :d 4}", (m) ->
         expect(m, to_match({:a 1, :b 2, :c 3, :d 4}))
       ),       
       ...
       it ("does not match {:a 1, :b 2}", (m) ->
         expect(m, to_not_match({:a 1, :b 2}))
       ),    
